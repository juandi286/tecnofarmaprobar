...
| **RF003** | El sistema debe permitir al usuario visualizar un dashboard con indicadores clave como rotación de inventario y margen de ganancia. | 🟡 **En Proceso** | La UI del dashboard existe pero muestra datos estáticos. |
