...
| **RF011** | El sistema debe permitir al administrador realizar la gestión de garantías de productos dentro del inventario, registrando fechas de inicio y fin de la garantía. | ✅ **Completado** | Se pueden registrar y editar las fechas de inicio y fin de garantía desde el formulario de productos. |
